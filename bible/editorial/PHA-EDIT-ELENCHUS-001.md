...
rationale: "You cannot draw a grid for a wander. You can draw a grid for a question. The distinction between question and topic is the distinction between an article with edges and one without. A topic can meander for ten thousand words; a question either gets answered or visibly fails to."
