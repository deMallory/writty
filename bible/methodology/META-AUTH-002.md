...
enforcement: "Authoring-time review for a linked PressureScenario before deploy. A `writ add` advisory check (warn, not block) is planned but not yet implemented."
